...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/flat-haze-5616)
...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/flat-haze-5616#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/flat-haze-5616
```

A live public deployment of this template is available at [https://flat-haze-5616.templates.workers.dev](https://flat-haze-5616.templates.workers.dev)
